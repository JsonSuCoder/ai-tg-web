"use strict";
(self["webpackChunkTelyAI"] = self["webpackChunkTelyAI"] || []).push([["src_config_ts-src_util_schedulers_ts"],{
...
/* harmony export */   AI_FOLDER_ID: () => (/* binding */ AI_FOLDER_ID),
/* harmony export */   AI_FOLDER_TITLE: () => (/* binding */ AI_FOLDER_TITLE),
...
/* harmony export */   GOOGLE_APP_CLIENT_ID: () => (/* binding */ GOOGLE_APP_CLIENT_ID),
/* harmony export */   GOOGLE_APP_CLIENT_SECRET: () => (/* binding */ GOOGLE_APP_CLIENT_SECRET),
...
/* harmony export */   PRESET_FOLDER_ID: () => (/* binding */ PRESET_FOLDER_ID),
/* harmony export */   PRESET_FOLDER_TITLE: () => (/* binding */ PRESET_FOLDER_TITLE),
...
/* harmony export */   PRODUCTION_SERVER_API_URL: () => (/* binding */ PRODUCTION_SERVER_API_URL),
/* harmony export */   PRODUCTION_TELEGPT_WS: () => (/* binding */ PRODUCTION_TELEGPT_WS),
...
/* harmony export */   RESALE_GIFTS_LIMIT: () => (/* binding */ RESALE_GIFTS_LIMIT),
...
/* harmony export */   STARS_SUGGESTED_POST_AGE_MIN: () => (/* binding */ STARS_SUGGESTED_POST_AGE_MIN),
/* harmony export */   STARS_SUGGESTED_POST_AMOUNT_MAX: () => (/* binding */ STARS_SUGGESTED_POST_AMOUNT_MAX),
/* harmony export */   STARS_SUGGESTED_POST_AMOUNT_MIN: () => (/* binding */ STARS_SUGGESTED_POST_AMOUNT_MIN),
/* harmony export */   STARS_SUGGESTED_POST_COMMISSION_PERMILLE: () => (/* binding */ STARS_SUGGESTED_POST_COMMISSION_PERMILLE),
/* harmony export */   STARS_SUGGESTED_POST_FUTURE_MAX: () => (/* binding */ STARS_SUGGESTED_POST_FUTURE_MAX),
/* harmony export */   STARS_SUGGESTED_POST_FUTURE_MIN: () => (/* binding */ STARS_SUGGESTED_POST_FUTURE_MIN),
...
/* harmony export */   TELEGPT_WS: () => (/* binding */ TELEGPT_WS),
...
/* harmony export */   TODO_ITEMS_LIMIT: () => (/* binding */ TODO_ITEMS_LIMIT),
/* harmony export */   TODO_ITEM_LENGTH_LIMIT: () => (/* binding */ TODO_ITEM_LENGTH_LIMIT),
/* harmony export */   TODO_TITLE_LENGTH_LIMIT: () => (/* binding */ TODO_TITLE_LENGTH_LIMIT),
/* harmony export */   TON_CURRENCY_CODE: () => (/* binding */ TON_CURRENCY_CODE),
/* harmony export */   TON_SUGGESTED_POST_AMOUNT_MAX: () => (/* binding */ TON_SUGGESTED_POST_AMOUNT_MAX),
/* harmony export */   TON_SUGGESTED_POST_AMOUNT_MIN: () => (/* binding */ TON_SUGGESTED_POST_AMOUNT_MIN),
/* harmony export */   TON_SUGGESTED_POST_COMMISSION_PERMILLE: () => (/* binding */ TON_SUGGESTED_POST_COMMISSION_PERMILLE),
/* harmony export */   TON_TOPUP_URL_DEFAULT: () => (/* binding */ TON_TOPUP_URL_DEFAULT),
/* harmony export */   TON_USD_RATE_DEFAULT: () => (/* binding */ TON_USD_RATE_DEFAULT),
...
/* harmony export */   UNREAD_FOLDER_ID: () => (/* binding */ UNREAD_FOLDER_ID),
/* harmony export */   UNREAD_FOLDER_TITLE: () => (/* binding */ UNREAD_FOLDER_TITLE),
...
const APP_NAME = 'TelyAI';
const RELEASE_DATETIME = 1775641670231;
const PRODUCTION_HOSTNAME = 'web.telegram.org';
// Telegpt相关配置
const PRODUCTION_URL = 'https://aquaverse.github.io/telegpt-web-app/';
const WEB_VERSION_BASE = 'https://web.telegram.org/'; // Used to redirect to other versions
const PRODUCTION_SERVER_API_URL = 'https://api.telegpt.org';
const PRODUCTION_TELEGPT_WS = 'https://api.telegpt.org';
const SERVER_API_URL = "https://api-test.telegpt.org";
const TELEGPT_WS = "wss://api-test.telegpt.org";
const BASE_URL = "https://aquaverse.github.io/telegpt-web-app/";
const ACCOUNT_QUERY = 'account';
const GOOGLE_APP_CLIENT_ID = "538884342692-p4m10vr5uvmscb3tk75fkd50nli8n8ot.apps.googleusercontent.com";
const GOOGLE_APP_CLIENT_SECRET = "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";
const GOOGLE_API_KEY = "AIzaSyDFV09Q1o2Zi48fJb269ORt4K-_jaHOEv4";
const IS_MOCKED_CLIENT = "" === '1';
const IS_TEST = "production" === 'test';
const IS_PERF = "production" === 'perf';
const IS_BETA = "production" === 'staging';
...
const RESALE_GIFTS_LIMIT = 50;
const TODO_ITEMS_LIMIT = 30;
const TODO_TITLE_LENGTH_LIMIT = 32;
const TODO_ITEM_LENGTH_LIMIT = 64;
...
const STARS_SUGGESTED_POST_AMOUNT_MAX = 100000;
const STARS_SUGGESTED_POST_AMOUNT_MIN = 5;
const STARS_SUGGESTED_POST_COMMISSION_PERMILLE = 850;
const STARS_SUGGESTED_POST_AGE_MIN = 86400; // 24 hours in seconds
const STARS_SUGGESTED_POST_FUTURE_MAX = 2678400; // 31 days in seconds
const STARS_SUGGESTED_POST_FUTURE_MIN = 300; // 5 minutes in seconds
const TON_CURRENCY_CODE = 'TON';
const TON_SUGGESTED_POST_COMMISSION_PERMILLE = 850;
const TON_USD_RATE_DEFAULT = 3;
const VERIFY_AGE_MIN_DEFAULT = 18;
const TON_TOPUP_URL_DEFAULT = 'https://fragment.com/ads/topup';
const TON_SUGGESTED_POST_AMOUNT_MIN = 10000000; // 0.01 TON in nanos
const TON_SUGGESTED_POST_AMOUNT_MAX = 10000000000000; // 10 000 TON in nanos
...
const UNREAD_FOLDER_ID = -2;
const UNREAD_FOLDER_TITLE = 'Unread';
const PRESET_FOLDER_ID = -3;
const PRESET_FOLDER_TITLE = 'Preset';
const AI_FOLDER_ID = -4;
...
//# sourceMappingURL=src_config_ts-src_util_schedulers_ts.8bc92ebd5481d891d619.js.map