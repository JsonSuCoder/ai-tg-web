"use strict";
(self["webpackChunkTelyAI"] = self["webpackChunkTelyAI"] || []).push([["src_components_common_AnimatedIconFromSticker_tsx-src_components_common_BadgeButton_tsx-src_c-99cb87"],{
...
const AnimatedCounter = ({
  ...
  const characters = (0,_teact__WEBPACK_IMPORTED_MODULE_0__.useMemo)(() => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,_teact__WEBPACK_IMPORTED_MODULE_0__.memo)(AnimatedCounter));
...
function renderAnimatedCharacters(text, prevText) {
  ...
  for (let i = 0; i <= textLength; i++) {
    ...
    if (prevText && prevTextCharIndex >= 0 && text[charIndex] !== prevText[prevTextCharIndex]) {
      elements.unshift(/*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("div", {
      ...
      }, text[charIndex] ?? ''), /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("div", {
        className: _AnimatedCounter_module_scss__WEBPACK_IMPORTED_MODULE_8__["default"].characterOld
      }, prevText[prevTextCharIndex]), /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("div", {
        className: _AnimatedCounter_module_scss__WEBPACK_IMPORTED_MODULE_8__["default"].characterNew
      }, text[charIndex] ?? '')));
    } else {
      elements.unshift(/*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("span", null, text[charIndex] ?? ''));
    }
  }
  return elements;
}
...
function AnimatedIconFromSticker(props) {
  ...
  return /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_AnimatedIconWithPreview__WEBPACK_IMPORTED_MODULE_4__["default"], _extends({
    tgsUrl: tgsUrl,
    previewUrl: previewBlobUrl,
    thumbDataUri: thumbDataUri
  }, otherProps));
}
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,_teact__WEBPACK_IMPORTED_MODULE_0__.memo)(AnimatedIconFromSticker));
...
function AnimatedIconWithPreview(props) {
  ...
  _teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("img", {
    src: thumbDataUri,
  ...
  }), /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_AnimatedIcon__WEBPACK_IMPORTED_MODULE_6__["default"], _extends({}, otherProps, {
    onLoad: handleAnimationReady
  })));
}
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,_teact__WEBPACK_IMPORTED_MODULE_0__.memo)(AnimatedIconWithPreview));
...
const AvatarList = ({
  ...
  const renderingBadgeText = (0,_teact__WEBPACK_IMPORTED_MODULE_0__.useMemo)(() => {
  ...
  }, peers?.slice(0, limit).map(peer => /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_Avatar__WEBPACK_IMPORTED_MODULE_3__["default"], {
    size: size,
    peer: peer,
    className: _AvatarList_module_scss__WEBPACK_IMPORTED_MODULE_4__["default"].avatar
  })), renderingBadgeText && /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("div", {
    className: _AvatarList_module_scss__WEBPACK_IMPORTED_MODULE_4__["default"].badge
  }, renderingBadgeText));
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,_teact__WEBPACK_IMPORTED_MODULE_0__.memo)(AvatarList));
...
const CalendarModalAsync = props => {
  ...
  return CalendarModal ? /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(CalendarModal, props) : undefined;
};
...
const MediaSpoiler = ({
  ...
  }), isNsfw && /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("span", {
    className: _MediaSpoiler_module_scss__WEBPACK_IMPORTED_MODULE_8__["default"].nsfw
  }, /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_icons_Icon__WEBPACK_IMPORTED_MODULE_7__["default"], {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,_teact__WEBPACK_IMPORTED_MODULE_0__.memo)(MediaSpoiler));
...
const PasswordForm = ({
  ...
  const [password, setPassword] = (0,_teact__WEBPACK_IMPORTED_MODULE_0__.useState)('');
  const [canSubmit, setCanSubmit] = (0,_teact__WEBPACK_IMPORTED_MODULE_0__.useState)(false);
  ...
  function renderFakeInput() {
    return /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("input", {
      type: "password",
      id: "prevent_autofill",
      autoComplete: "off",
  ...
  return /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("form", {
    action: "",
  ...
  }, shouldDisablePasswordManager && renderFakeInput(), /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("input", {
    ref: inputRef,
    ...
    maxLength: 256,
    dir: "auto"
  }), /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("label", null, error || hint || placeholder), /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("div", {
  ...
  }, description), onSubmit && (canSubmit || shouldShowSubmit) && /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_ui_Button__WEBPACK_IMPORTED_MODULE_9__["default"], {
    size: "smaller",
    type: "submit",
    ripple: !noRipple,
    isLoading: isLoading,
...
const PeerChip = ({
  ...
  let titleText;
  if (icon && title) {
    iconElement = /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("div", {
      className: _PeerChip_module_scss__WEBPACK_IMPORTED_MODULE_10__["default"].iconWrapper
    }, /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_icons_Icon__WEBPACK_IMPORTED_MODULE_9__["default"], {
      name: icon,
      style: _PeerChip_module_scss__WEBPACK_IMPORTED_MODULE_10__["default"].icon
    }));
    titleElement = title;
  } else if (anyPeer) {
    iconElement = /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_Avatar__WEBPACK_IMPORTED_MODULE_7__["default"], {
    ...
    titleElement = title || /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_FullNameTitle__WEBPACK_IMPORTED_MODULE_8__["default"], {
      peer: anyPeer,
      isSavedMessages: isSavedMessages,
  ...
  return /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("div", {
    ...
    dir: lang.isRtl ? 'rtl' : undefined
  }, iconElement, !isMinimized && /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("div", {
    ...
    dir: "auto"
  }, titleElement), canClose && /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("div", {
...
const PinMessageModalAsync = props => {
  ...
  return PinMessageModal ? /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(PinMessageModal, props) : undefined;
};
...
const PremiumProgress = ({
  ...
  const parentContainerRef = (0,_teact__WEBPACK_IMPORTED_MODULE_0__.useRef)();
  const [shiftX, setShiftX] = (0,_teact__WEBPACK_IMPORTED_MODULE_0__.useState)(0);
  const [tailPosition, setTailPosition] = (0,_teact__WEBPACK_IMPORTED_MODULE_0__.useState)(0);
  ...
  (0,_teact__WEBPACK_IMPORTED_MODULE_0__.useEffect)(updateBadgePosition, [progress]);
  ...
  return /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("div", {
  ...
  }, hasFloatingBadge && /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("div", {
  ...
  }, floatingBadgeIcon && /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_icons_Icon__WEBPACK_IMPORTED_MODULE_5__["default"], {
    name: floatingBadgeIcon,
    className: _PremiumProgress_module_scss__WEBPACK_IMPORTED_MODULE_6__["default"].floatingBadgeIcon
  }), floatingBadgeText && /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("div", {
  ...
  }, /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("span", null, leftText)), /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("div", {
    className: _PremiumProgress_module_scss__WEBPACK_IMPORTED_MODULE_6__["default"].right
  }, /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("span", null, rightText)), /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("div", {
    ...
    className: _PremiumProgress_module_scss__WEBPACK_IMPORTED_MODULE_6__["default"].right
  }, /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("span", null, rightText))));
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,_teact__WEBPACK_IMPORTED_MODULE_0__.memo)(PremiumProgress));
...
const PeerPicker = ({
  ...
  const selectedCategories = (0,_teact__WEBPACK_IMPORTED_MODULE_0__.useMemo)(() => {
    if (allowMultiple) {
  ...
  const selectedIds = (0,_teact__WEBPACK_IMPORTED_MODULE_0__.useMemo)(() => {
    if (allowMultiple) {
  ...
  const lockedSelectedIdsSet = (0,_teact__WEBPACK_IMPORTED_MODULE_0__.useMemo)(() => new Set(lockedSelectedIds), [lockedSelectedIds]);
  const lockedUnselectedIdsSet = (0,_teact__WEBPACK_IMPORTED_MODULE_0__.useMemo)(() => new Set(lockedUnselectedIds), [lockedUnselectedIds]);
  const unlockedSelectedIds = (0,_teact__WEBPACK_IMPORTED_MODULE_0__.useMemo)(() => {
    return selectedIds.filter(id => !lockedSelectedIdsSet.has(id));
  }, [lockedSelectedIdsSet, selectedIds]);
  const categoriesByType = (0,_teact__WEBPACK_IMPORTED_MODULE_0__.useMemo)(() => {
    if (!categories) return {};
    return (0,_util_iteratees__WEBPACK_IMPORTED_MODULE_8__.buildCollectionByKey)(categories, 'type');
  }, [categories]);
  const sortedItemIds = (0,_teact__WEBPACK_IMPORTED_MODULE_0__.useMemo)(() => {
    if (filterValue) {
      return itemIds;
    }
  ...
  const renderItem = (0,_teact__WEBPACK_IMPORTED_MODULE_0__.useCallback)((id, isCategory) => {
    ...
    function getInputElement() {
      if (isLocked) return /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_icons_Icon__WEBPACK_IMPORTED_MODULE_20__["default"], {
        name: "lock-badge"
      });
      if (itemInputType === 'radio') {
        return /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_ui_Radio__WEBPACK_IMPORTED_MODULE_17__["default"], {
          checked: isChecked,
          disabled: isLocked,
          onlyInput: true
        });
      ...
      if (itemInputType === 'checkbox') {
        return /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_ui_Checkbox__WEBPACK_IMPORTED_MODULE_13__["default"], {
          checked: isChecked,
          disabled: isLocked,
          onlyInput: true
        });
    ...
    return /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_PickerItem__WEBPACK_IMPORTED_MODULE_22__["default"], {
      key: id,
      className: (0,_util_buildClassName__WEBPACK_IMPORTED_MODULE_7__["default"])(ITEM_CLASS_NAME, itemClassName),
      title: /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_FullNameTitle__WEBPACK_IMPORTED_MODULE_19__["default"], {
        peer: peerOrCategory
      }),
      avatarElement: /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_Avatar__WEBPACK_IMPORTED_MODULE_18__["default"], {
        peer: peer || category,
  ...
  const beforeChildren = (0,_teact__WEBPACK_IMPORTED_MODULE_0__.useMemo)(() => {
    if (!categories?.length) return undefined;
    return /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("div", {
      key: "categories"
    }, categoryPlaceholderKey && /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("div", {
      className: _PickerStyles_module_scss__WEBPACK_IMPORTED_MODULE_23__["default"].pickerCategoryTitle
    }, lang(categoryPlaceholderKey)), categories?.map(category => renderItem(category.type, true)), /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("div", {
      className: _PickerStyles_module_scss__WEBPACK_IMPORTED_MODULE_23__["default"].pickerCategoryTitle
    }, lang('FilterChats')));
  ...
  return /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("div", {
  ...
  }, isSearchable && /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("div", {
    ...
    dir: lang.isRtl ? 'rtl' : undefined
  }, selectedCategories?.map(category => /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_PeerChip__WEBPACK_IMPORTED_MODULE_21__["default"], {
    ...
    clickArg: category,
    canClose: true
  })), lockedSelectedIds?.map((id, i) => /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_PeerChip__WEBPACK_IMPORTED_MODULE_21__["default"], {
    className: _PickerStyles_module_scss__WEBPACK_IMPORTED_MODULE_23__["default"].peerChip,
    peerId: id,
    ...
    onClick: handleItemClick,
    clickArg: id
  })), unlockedSelectedIds.map((id, i) => /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_PeerChip__WEBPACK_IMPORTED_MODULE_21__["default"], {
    className: _PickerStyles_module_scss__WEBPACK_IMPORTED_MODULE_23__["default"].peerChip,
    peerId: id,
    ...
    onClick: handleItemClick,
    clickArg: id
  })), /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_ui_InputText__WEBPACK_IMPORTED_MODULE_15__["default"], {
    id: searchInputId,
    ref: inputRef,
    value: filterValue,
    onChange: handleFilterChange,
    placeholder: filterPlaceholder || lang('SelectChat')
  })), viewportIds?.length ? /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_ui_InfiniteScroll__WEBPACK_IMPORTED_MODULE_14__["default"], {
  ...
  }, viewportIds.map(id => renderItem(id))) : !isLoading && viewportIds && !viewportIds.length ? /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("p", {
    className: _PickerStyles_module_scss__WEBPACK_IMPORTED_MODULE_23__["default"].noResults
  }, notFoundText || 'Sorry, nothing found.') : /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_ui_Loading__WEBPACK_IMPORTED_MODULE_16__["default"], null));
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,_teact__WEBPACK_IMPORTED_MODULE_0__.memo)(PeerPicker));
...
const PickerItem = ({
  ...
  }, !disabled && !inactive && ripple && /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_ui_RippleEffect__WEBPACK_IMPORTED_MODULE_5__["default"], null), Boolean(inputElement) && /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("div", {
  ...
  }, inputElement), Boolean(avatarElement) && /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("div", {
    className: _PickerItem_module_scss__WEBPACK_IMPORTED_MODULE_6__["default"].avatarElement
  }, avatarElement), /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("div", {
  ...
  }, subtitle), !inputElement && _util_browser_windowEnvironment__WEBPACK_IMPORTED_MODULE_1__.IS_IOS && /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("div", {
...
const RadialPatternBackground = ({
  ...
  const [getContainerSize, setContainerSize] = (0,_teact__WEBPACK_IMPORTED_MODULE_0__.useSignal)({
    width: 0,
    height: 0
  });
  const dpr = (0,_hooks_window_useDevicePixelRatio__WEBPACK_IMPORTED_MODULE_9__["default"])();
  const [emojiImage, setEmojiImage] = (0,_teact__WEBPACK_IMPORTED_MODULE_0__.useState)();
  ...
  const patternPositions = (0,_teact__WEBPACK_IMPORTED_MODULE_0__.useMemo)(() => {
    const coordinates = [];
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,_teact__WEBPACK_IMPORTED_MODULE_0__.memo)(RadialPatternBackground));
...
const CustomEmojiEffect = ({
  ...
  const paths = (0,_teact__WEBPACK_IMPORTED_MODULE_0__.useMemo)(() => {
  ...
  return /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("div", {
    ...
    if (isLottie) {
      return /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_CustomEmoji__WEBPACK_IMPORTED_MODULE_6__["default"], {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,_teact__WEBPACK_IMPORTED_MODULE_0__.memo)(CustomEmojiEffect));
...
const PaidReactionEmoji = ({
  ...
  const [effectsIds, setEffectsIds] = (0,_teact__WEBPACK_IMPORTED_MODULE_0__.useState)([]);
  ...
  const activeReaction = (0,_teact__WEBPACK_IMPORTED_MODULE_0__.useMemo)(() => activeReactions?.find(active => (0,_global_helpers__WEBPACK_IMPORTED_MODULE_2__.isSameReaction)(active, reaction)), [activeReactions, reaction]);
  ...
  return /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("div", {
    ...
    ref: ref,
    teactFastList: true
  }, /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_icons_StarIcon__WEBPACK_IMPORTED_MODULE_13__["default"], {
    key: "icon",
    type: "gold",
    size: "adaptive",
    style: `width: ${size}px; height: ${size}px`
  }), shouldRenderEffect && effectsIds.map(id => /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_AnimatedIcon__WEBPACK_IMPORTED_MODULE_12__["default"], {
    key: id,
    ref: effectRef,
...
const ReactionAnimatedEmoji = ({
  ...
  const availableReaction = (0,_teact__WEBPACK_IMPORTED_MODULE_0__.useMemo)(() => availableReactions?.find(r => (0,_global_helpers__WEBPACK_IMPORTED_MODULE_2__.isSameReaction)(r.reaction, reaction)), [availableReactions, reaction]);
  const centerIconId = availableReaction?.centerIcon?.id;
  const {
    customEmoji
  } = (0,_hooks_useCustomEmoji__WEBPACK_IMPORTED_MODULE_12__["default"])(isCustom ? reaction.documentId : undefined);
  const assignedEffectId = (0,_teact__WEBPACK_IMPORTED_MODULE_0__.useMemo)(() => {
  ...
  const effectId = (0,_teact__WEBPACK_IMPORTED_MODULE_0__.useMemo)(() => {
    if (assignedEffectId) {
  ...
  return /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("div", {
    className: rootClassName,
    ref: ref
  }, !withEffectOnly && shouldRenderStatic && /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_ReactionStaticEmoji__WEBPACK_IMPORTED_MODULE_16__["default"], {
    className: staticClassNames,
    reaction: reaction,
    availableReactions: availableReactions,
    size: size,
    observeIntersection: observeIntersection
  }), !withEffectOnly && isCustom && /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_CustomEmoji__WEBPACK_IMPORTED_MODULE_14__["default"], {
    documentId: reaction.documentId,
    ...
    forceAlways: true
  }), shouldRenderCenter && !isCustom && /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_AnimatedSticker__WEBPACK_IMPORTED_MODULE_13__["default"], {
    ...
    forceAlways: true
  }), shouldRenderEffect && /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_teact__WEBPACK_IMPORTED_MODULE_0__["default"].Fragment, null, /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_AnimatedSticker__WEBPACK_IMPORTED_MODULE_13__["default"], {
    ...
    onEnded: handleEnded,
    forceAlways: true
  }), isCustom && !assignedEffectId && isIntersecting && /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_CustomEmojiEffect__WEBPACK_IMPORTED_MODULE_15__["default"], {
    reaction: reaction,
...
const ReactionStaticEmoji = ({
  ...
  const availableReaction = (0,_teact__WEBPACK_IMPORTED_MODULE_0__.useMemo)(() => availableReactions?.find(available => (0,_global_helpers__WEBPACK_IMPORTED_MODULE_1__.isSameReaction)(available.reaction, reaction)), [availableReactions, reaction]);
  ...
  if (reaction.type === 'custom') {
    return /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_CustomEmoji__WEBPACK_IMPORTED_MODULE_5__["default"], {
      documentId: reaction.documentId,
  ...
  if (shouldReplaceWithHeartIcon) {
    return /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_icons_Icon__WEBPACK_IMPORTED_MODULE_6__["default"], {
      name: "heart",
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,_teact__WEBPACK_IMPORTED_MODULE_0__.memo)(ReactionStaticEmoji));
...
/* harmony import */ var _util_subscriptionHandler__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../../../util/subscriptionHandler */ "./src/util/subscriptionHandler.ts");
/* harmony import */ var _chatAssistant_agent_utils__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../../chatAssistant/agent/utils */ "./src/components/chatAssistant/agent/utils.ts");
/* harmony import */ var _helpers_getSelectionAsFormattedText__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./helpers/getSelectionAsFormattedText */ "./src/components/middle/message/helpers/getSelectionAsFormattedText.ts");
/* harmony import */ var _helpers_isSelectionRangeInsideMessage__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./helpers/isSelectionRangeInsideMessage */ "./src/components/middle/message/helpers/isSelectionRangeInsideMessage.ts");
...
/* harmony import */ var _hooks_useSchedule__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ../../../hooks/useSchedule */ "./src/hooks/useSchedule.tsx");
...
/* harmony import */ var _common_PinMessageModal_async__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ../../common/PinMessageModal.async */ "./src/components/common/PinMessageModal.async.tsx");
...
/* harmony import */ var _MessageContextMenu__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ./MessageContextMenu */ "./src/components/middle/message/MessageContextMenu.tsx");
...
const ContextMenuContainer = ({
  ...
  const [isMenuOpen, setIsMenuOpen] = (0,_teact__WEBPACK_IMPORTED_MODULE_0__.useState)(true);
  const [isPinModalOpen, setIsPinModalOpen] = (0,_teact__WEBPACK_IMPORTED_MODULE_0__.useState)(false);
  const [isClosePollDialogOpen, openClosePollDialog, closeClosePollDialog] = (0,_hooks_useFlag__WEBPACK_IMPORTED_MODULE_14__["default"])();
  const [selectionQuoteOffset, setSelectionQuoteOffset] = (0,_teact__WEBPACK_IMPORTED_MODULE_0__.useState)(UNQUOTABLE_OFFSET);
  const [requestCalendar, calendar] = (0,_hooks_useSchedule__WEBPACK_IMPORTED_MODULE_18__["default"])(canScheduleUntilOnline, onClose, message.date);
  ...
  const seenByRecentPeers = (0,_teact__WEBPACK_IMPORTED_MODULE_0__.useMemo)(() => {
  ...
  const isDownloading = (0,_teact__WEBPACK_IMPORTED_MODULE_0__.useMemo)(() => {
    const global = (0,_global__WEBPACK_IMPORTED_MODULE_1__.getGlobal)();
    if (album) {
  ...
  (0,_teact__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    ...
    const isMessageTextSelected = selectionRange && !selectionRange.collapsed && Boolean(message.content.text?.text) && (0,_helpers_isSelectionRangeInsideMessage__WEBPACK_IMPORTED_MODULE_13__.isSelectionRangeInsideMessage)(selectionRange);
    if (!isMessageTextSelected) {
      setSelectionQuoteOffset(UNQUOTABLE_OFFSET);
      return;
    }
    const selectionText = (0,_helpers_getSelectionAsFormattedText__WEBPACK_IMPORTED_MODULE_12__.getSelectionAsFormattedText)(selectionRange);
  ...
  const closeMenu = (0,_hooks_useLastCallback__WEBPACK_IMPORTED_MODULE_16__["default"])(() => {
    setIsMenuOpen(false);
    onClose();
  });
  ...
  const closePinModal = (0,_hooks_useLastCallback__WEBPACK_IMPORTED_MODULE_16__["default"])(() => {
    setIsPinModalOpen(false);
    onClose();
  });
  const handleAskAi = (0,_hooks_useLastCallback__WEBPACK_IMPORTED_MODULE_16__["default"])(() => {
    if (!(0,_util_subscriptionHandler__WEBPACK_IMPORTED_MODULE_10__.checkCredisBalance)()) {
      openPayPackageModal();
      return;
    }
    const quoteText = selectionQuoteOffset !== UNQUOTABLE_OFFSET && selectionRange ? (0,_helpers_getSelectionAsFormattedText__WEBPACK_IMPORTED_MODULE_12__.getSelectionAsFormattedText)(selectionRange) : undefined;
    const selectedMessages = [(0,_chatAssistant_agent_utils__WEBPACK_IMPORTED_MODULE_11__.buildAgentSelectedMessage)(message, userFullName, quoteText?.text)];
    openChatAIWithInfo({
      chatId: message.chatId,
      selectedMessages
    });
  ...
  const handleReply = (0,_hooks_useLastCallback__WEBPACK_IMPORTED_MODULE_16__["default"])(() => {
    const quoteText = selectionQuoteOffset !== UNQUOTABLE_OFFSET && selectionRange ? (0,_helpers_getSelectionAsFormattedText__WEBPACK_IMPORTED_MODULE_12__.getSelectionAsFormattedText)(selectionRange) : undefined;
    if (!canReplyInChat) {
      openReplyMenu({
  ...
  const handleOpenThread = (0,_hooks_useLastCallback__WEBPACK_IMPORTED_MODULE_16__["default"])(() => {
    openThread({
      chatId: message.chatId,
      threadId: message.id
    });
  ...
  const handleEdit = (0,_hooks_useLastCallback__WEBPACK_IMPORTED_MODULE_16__["default"])(() => {
  ...
  const handleAppendTodoList = (0,_hooks_useLastCallback__WEBPACK_IMPORTED_MODULE_16__["default"])(() => {
  ...
  const handlePin = (0,_hooks_useLastCallback__WEBPACK_IMPORTED_MODULE_16__["default"])(() => {
    setIsMenuOpen(false);
    setIsPinModalOpen(true);
  });
  const handleUnpin = (0,_hooks_useLastCallback__WEBPACK_IMPORTED_MODULE_16__["default"])(() => {
    pinMessage({
      chatId: message.chatId,
      messageId: message.id,
      isUnpin: true
  ...
  const handleForward = (0,_hooks_useLastCallback__WEBPACK_IMPORTED_MODULE_16__["default"])(() => {
    closeMenu();
    if (album?.messages) {
  ...
  const handleCopyForward = (0,_hooks_useLastCallback__WEBPACK_IMPORTED_MODULE_16__["default"])(() => {
    closeMenu();
    if (album?.messages) {
      const messageIds = album.messages.map(({
        id
  ...
  const handleFaveSticker = (0,_hooks_useLastCallback__WEBPACK_IMPORTED_MODULE_16__["default"])(() => {
    closeMenu();
    faveSticker({
      sticker: message.content.sticker
    });
  });
  const handleUnfaveSticker = (0,_hooks_useLastCallback__WEBPACK_IMPORTED_MODULE_16__["default"])(() => {
    closeMenu();
    unfaveSticker({
      sticker: message.content.sticker
    });
  });
  const handleCancelVote = (0,_hooks_useLastCallback__WEBPACK_IMPORTED_MODULE_16__["default"])(() => {
    closeMenu();
    cancelPollVote({
      chatId: message.chatId,
      messageId: message.id
  ...
  const handlePollClose = (0,_hooks_useLastCallback__WEBPACK_IMPORTED_MODULE_16__["default"])(() => {
    closeMenu();
    closePoll({
      chatId: message.chatId,
      messageId: message.id
  ...
  const handleSelectMessage = (0,_hooks_useLastCallback__WEBPACK_IMPORTED_MODULE_16__["default"])(() => {
  ...
  const handleScheduledMessageSend = (0,_hooks_useLastCallback__WEBPACK_IMPORTED_MODULE_16__["default"])(() => {
    sendScheduledMessages({
      chatId: message.chatId,
      id: message.id
    });
  ...
  const handleRescheduleMessage = (0,_hooks_useLastCallback__WEBPACK_IMPORTED_MODULE_16__["default"])(scheduledAt => {
    rescheduleMessage({
      chatId: message.chatId,
      messageId: message.id,
      scheduledAt
  ...
  const handleOpenCalendar = (0,_hooks_useLastCallback__WEBPACK_IMPORTED_MODULE_16__["default"])(() => {
    setIsMenuOpen(false);
    requestCalendar(handleRescheduleMessage);
  });
  const handleOpenSeenByModal = (0,_hooks_useLastCallback__WEBPACK_IMPORTED_MODULE_16__["default"])(() => {
    closeMenu();
    openSeenByModal({
      chatId: message.chatId,
      messageId: message.id
  ...
  const handleOpenReactorListModal = (0,_hooks_useLastCallback__WEBPACK_IMPORTED_MODULE_16__["default"])(() => {
    closeMenu();
    openReactorListModal({
      chatId: message.chatId,
      messageId: message.id
  ...
  const handleCopyMessages = (0,_hooks_useLastCallback__WEBPACK_IMPORTED_MODULE_16__["default"])(messageIds => {
    copyMessagesByIds({
      messageIds
    });
    closeMenu();
  });
  const handleCopyLink = (0,_hooks_useLastCallback__WEBPACK_IMPORTED_MODULE_16__["default"])(() => {
    copyMessageLink({
      chatId: message.chatId,
      messageId: message.id,
  ...
  const handleCopyNumber = (0,_hooks_useLastCallback__WEBPACK_IMPORTED_MODULE_16__["default"])(() => {
    (0,_util_clipboard__WEBPACK_IMPORTED_MODULE_8__.copyTextToClipboard)(message.content.contact.phoneNumber);
    closeMenu();
  });
  const handleDownloadClick = (0,_hooks_useLastCallback__WEBPACK_IMPORTED_MODULE_16__["default"])(() => {
    const global = (0,_global__WEBPACK_IMPORTED_MODULE_1__.getGlobal)();
  ...
  const handleSaveGif = (0,_hooks_useLastCallback__WEBPACK_IMPORTED_MODULE_16__["default"])(() => {
  ...
  const handleToggleReaction = (0,_hooks_useLastCallback__WEBPACK_IMPORTED_MODULE_16__["default"])(reaction => {
  ...
  const handleSendPaidReaction = (0,_hooks_useLastCallback__WEBPACK_IMPORTED_MODULE_16__["default"])(() => {
    addLocalPaidReaction({
      chatId: message.chatId,
      messageId: message.id,
      count: 1
  ...
  const handlePaidReactionModalOpen = (0,_hooks_useLastCallback__WEBPACK_IMPORTED_MODULE_16__["default"])(() => {
    openPaidReactionModal({
      chatId: message.chatId,
      messageId: message.id
    });
  ...
  const handleReactionPickerOpen = (0,_hooks_useLastCallback__WEBPACK_IMPORTED_MODULE_16__["default"])(position => {
    openMessageReactionPicker({
      chatId: message.chatId,
      messageId: message.id,
      position
  ...
  const handleTranslate = (0,_hooks_useLastCallback__WEBPACK_IMPORTED_MODULE_16__["default"])(() => {
    if (!(0,_util_subscriptionHandler__WEBPACK_IMPORTED_MODULE_10__.checkCredisBalance)()) {
      closeMenu();
      openCreditLimitModal({
  ...
  const handleShowOriginal = (0,_hooks_useLastCallback__WEBPACK_IMPORTED_MODULE_16__["default"])(() => {
    showOriginalMessage({
      chatId: message.chatId,
      id: message.id
    });
  ...
  const handleSelectLanguage = (0,_hooks_useLastCallback__WEBPACK_IMPORTED_MODULE_16__["default"])(() => {
    openChatLanguageModal({
      chatId: message.chatId,
      messageId: message.id
    });
  ...
  const reportMessageIds = (0,_teact__WEBPACK_IMPORTED_MODULE_0__.useMemo)(() => (album ? album.messages : [message]).map(({
    id
  }) => id), [album, message]);
  ...
  return /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("div", {
  ...
  }, /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_MessageContextMenu__WEBPACK_IMPORTED_MODULE_22__["default"], {
    ...
    canGift: canGift
  }), /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_common_PinMessageModal_async__WEBPACK_IMPORTED_MODULE_20__["default"], {
    isOpen: isPinModalOpen,
    messageId: message.id,
    chatId: message.chatId,
    onClose: closePinModal
  }), /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_ui_ConfirmDialog__WEBPACK_IMPORTED_MODULE_21__["default"], {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,_teact__WEBPACK_IMPORTED_MODULE_0__.memo)((0,_global__WEBPACK_IMPORTED_MODULE_1__.withGlobal)((global, {
  ...
  const todoItemsMax = global.appConfig?.todoItemsMax || _config__WEBPACK_IMPORTED_MODULE_3__.TODO_ITEMS_LIMIT;
...
function LastEditTimeMenuItem({
  ...
  return /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_ui_MenuItem__WEBPACK_IMPORTED_MODULE_3__["default"], {
    icon: "clock-edit",
    className: _TimeMenuItem_module_scss__WEBPACK_IMPORTED_MODULE_5__["default"].item
  }, shouldRenderSkeleton ? /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_ui_placeholder_Skeleton__WEBPACK_IMPORTED_MODULE_4__["default"], {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,_teact__WEBPACK_IMPORTED_MODULE_0__.memo)(LastEditTimeMenuItem));
...
/* harmony import */ var _helpers_copyOptions__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./helpers/copyOptions */ "./src/components/middle/message/helpers/copyOptions.ts");
...
/* harmony import */ var _LastEditTimeMenuItem__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./LastEditTimeMenuItem */ "./src/components/middle/message/LastEditTimeMenuItem.tsx");
/* harmony import */ var _reactions_ReactionSelector__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./reactions/ReactionSelector */ "./src/components/middle/message/reactions/ReactionSelector.tsx");
/* harmony import */ var _ReadTimeMenuItem__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ./ReadTimeMenuItem */ "./src/components/middle/message/ReadTimeMenuItem.tsx");
/* harmony import */ var _MessageContextMenu_scss__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ./MessageContextMenu.scss */ "./src/components/middle/message/MessageContextMenu.scss");
...
const MessageContextMenu = ({
  ...
  const scrollableRef = (0,_teact__WEBPACK_IMPORTED_MODULE_0__.useRef)();
  ...
  const [areItemsHidden, hideItems] = (0,_hooks_useFlag__WEBPACK_IMPORTED_MODULE_11__["default"])();
  const [isReady, markIsReady, unmarkIsReady] = (0,_hooks_useFlag__WEBPACK_IMPORTED_MODULE_11__["default"])();
  const {
    isMobile,
    isDesktop
  } = (0,_hooks_useAppLayout__WEBPACK_IMPORTED_MODULE_10__["default"])();
  const seenByDatesCount = (0,_teact__WEBPACK_IMPORTED_MODULE_0__.useMemo)(() => seenByDates ? Object.keys(seenByDates).length : 0, [seenByDates]);
  const handleAfterCopy = (0,_hooks_useLastCallback__WEBPACK_IMPORTED_MODULE_13__["default"])(() => {
    showNotification({
      message: oldLang('Share.Link.Copied')
    });
    onClose();
  });
  const handleGiftClick = (0,_hooks_useLastCallback__WEBPACK_IMPORTED_MODULE_13__["default"])(() => {
    openGiftModal({
  ...
  const handleOpenCustomEmojiSets = (0,_hooks_useLastCallback__WEBPACK_IMPORTED_MODULE_13__["default"])(() => {
  ...
  const copyOptions = (0,_helpers_copyOptions__WEBPACK_IMPORTED_MODULE_9__.getMessageCopyOptions)(message, (0,_global_helpers__WEBPACK_IMPORTED_MODULE_2__.groupStatefulContent)({
    poll,
    webPage,
    story
  }), targetHref, canCopy, handleAfterCopy, canCopyLink ? onCopyLink : undefined, onCopyMessages, onCopyNumber);
  const getTriggerElement = (0,_hooks_useLastCallback__WEBPACK_IMPORTED_MODULE_13__["default"])(() => {
    return document.querySelector(`.Transition_slide-active > .MessageList div[data-message-id="${message.id}"]`);
  });
  const getRootElement = (0,_hooks_useLastCallback__WEBPACK_IMPORTED_MODULE_13__["default"])(() => document.querySelector('.Transition_slide-active > .MessageList'));
  const getMenuElement = (0,_hooks_useLastCallback__WEBPACK_IMPORTED_MODULE_13__["default"])(() => document.querySelector('.MessageContextMenu .bubble'));
  const getLayout = (0,_hooks_useLastCallback__WEBPACK_IMPORTED_MODULE_13__["default"])(() => {
    ...
    return {
      ...
      menuElMinWidth: withReactions && isMobile ? REACTION_SELECTOR_WIDTH_REM * _common_helpers_mediaDimensions__WEBPACK_IMPORTED_MODULE_7__.REM : undefined
    };
  });
  (0,_teact__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    if (!isOpen) {
  ...
  const handleOpenMessageReactionPicker = (0,_hooks_useLastCallback__WEBPACK_IMPORTED_MODULE_13__["default"])(position => {
    onReactionPickerOpen(position);
    hideItems();
  });
  return /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_ui_Menu__WEBPACK_IMPORTED_MODULE_16__["default"], {
    ref: menuRef,
    isOpen: isOpen,
    anchor: anchor,
  ...
  }, withReactions && /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_reactions_ReactionSelector__WEBPACK_IMPORTED_MODULE_21__["default"], {
    enabledReactions: enabledReactions,
    topReactions: topReactions,
  ...
  }, canAskAi && /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_ui_MenuItem__WEBPACK_IMPORTED_MODULE_17__["default"], {
    customIcon: /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("img", {
      className: "w-[20px] h-[20px] ml-[0.5rem] mr-[1.25rem]",
      src: _chatAssistant_assets_serena_png__WEBPACK_IMPORTED_MODULE_6__,
      alt: ""
    }),
    onClick: onAskAi
  }, "Ask TelyAI"), shouldShowGiftButton && /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_ui_MenuItem__WEBPACK_IMPORTED_MODULE_17__["default"], {
    icon: "gift",
    onClick: handleGiftClick
  }, message?.isOutgoing ? oldLang('SendAnotherGift') : oldLang('Conversation.ContextMenuSendGiftTo', userFullName)), canSendNow && /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_ui_MenuItem__WEBPACK_IMPORTED_MODULE_17__["default"], {
    icon: "send-outline",
    onClick: onSend
  }, oldLang('MessageScheduleSend')), canReschedule && /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_ui_MenuItem__WEBPACK_IMPORTED_MODULE_17__["default"], {
    icon: "schedule",
    onClick: onReschedule
  }, oldLang('MessageScheduleEditTime')), canReply && /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_ui_MenuItem__WEBPACK_IMPORTED_MODULE_17__["default"], {
    icon: "reply",
    onClick: onReply
  }, oldLang(canQuote ? 'lng_context_quote_and_reply' : 'Reply')), !noReplies && Boolean(repliesThreadInfo?.messagesCount) && /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_ui_MenuItem__WEBPACK_IMPORTED_MODULE_17__["default"], {
    icon: "replies",
    onClick: onOpenThread
  }, oldLang('Conversation.ContextViewReplies', repliesThreadInfo.messagesCount, 'i')), canEdit && /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_ui_MenuItem__WEBPACK_IMPORTED_MODULE_17__["default"], {
    icon: "edit",
    onClick: onEdit
  }, oldLang('Edit')), canAppendTodoList && /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_ui_MenuItem__WEBPACK_IMPORTED_MODULE_17__["default"], {
    icon: "add",
    onClick: onAppendTodoList
  }, lang('MenuButtonAppendTodoList')), canFaveSticker && /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_ui_MenuItem__WEBPACK_IMPORTED_MODULE_17__["default"], {
    icon: "favorite",
    onClick: onFaveSticker
  }, oldLang('AddToFavorites')), canUnfaveSticker && /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_ui_MenuItem__WEBPACK_IMPORTED_MODULE_17__["default"], {
    icon: "favorite",
    onClick: onUnfaveSticker
  }, oldLang('Stickers.RemoveFromFavorites')), canTranslate && /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_ui_MenuItem__WEBPACK_IMPORTED_MODULE_17__["default"], {
    icon: "language",
    onClick: onTranslate
  }, oldLang('TranslateMessage')), canShowOriginal && /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_ui_MenuItem__WEBPACK_IMPORTED_MODULE_17__["default"], {
    icon: "language",
    onClick: onShowOriginal
  }, oldLang('ShowOriginalButton')), canSelectLanguage && /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_ui_MenuItem__WEBPACK_IMPORTED_MODULE_17__["default"], {
    icon: "web",
    onClick: onSelectLanguage
  }, oldLang('lng_settings_change_lang')), copyOptions.map(option => /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_ui_MenuItem__WEBPACK_IMPORTED_MODULE_17__["default"], {
    key: option.label,
    icon: option.icon,
    onClick: option.handler,
    withPreventDefaultOnMouseDown: true
  }, oldLang(option.label))), canPin && /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_ui_MenuItem__WEBPACK_IMPORTED_MODULE_17__["default"], {
    icon: "pin",
    onClick: onPin
  }, oldLang('DialogPin')), canUnpin && /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_ui_MenuItem__WEBPACK_IMPORTED_MODULE_17__["default"], {
    icon: "unpin",
    onClick: onUnpin
  }, oldLang('DialogUnpin')), canSaveGif && /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_ui_MenuItem__WEBPACK_IMPORTED_MODULE_17__["default"], {
    icon: "gifs",
    onClick: onSaveGif
  }, oldLang('lng_context_save_gif')), canRevote && /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_ui_MenuItem__WEBPACK_IMPORTED_MODULE_17__["default"], {
    icon: "revote",
    onClick: onCancelVote
  }, oldLang('lng_polls_retract')), canClosePoll && /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_ui_MenuItem__WEBPACK_IMPORTED_MODULE_17__["default"], {
    icon: "stop",
    onClick: onClosePoll
  }, oldLang('lng_polls_stop')), canDownload && /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_ui_MenuItem__WEBPACK_IMPORTED_MODULE_17__["default"], {
    icon: "download",
    onClick: onDownload
  }, isDownloading ? oldLang('lng_context_cancel_download') : oldLang('lng_media_download')), canForward && /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_ui_MenuItem__WEBPACK_IMPORTED_MODULE_17__["default"], {
    icon: "forward",
    onClick: onForward
  }, oldLang('Forward')), canSelect && /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_ui_MenuItem__WEBPACK_IMPORTED_MODULE_17__["default"], {
    icon: "select",
    onClick: onSelect
  }, oldLang('Common.Select')), canReport && /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_ui_MenuItem__WEBPACK_IMPORTED_MODULE_17__["default"], {
    icon: "flag",
    onClick: onReport
  }, oldLang('lng_context_report_msg')), canDelete && /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_ui_MenuItem__WEBPACK_IMPORTED_MODULE_17__["default"], {
    destructive: true,
    icon: "delete",
    onClick: onDelete
  }, oldLang('Delete')), canForward && /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_ui_MenuItem__WEBPACK_IMPORTED_MODULE_17__["default"], {
    icon: "forward",
    onClick: onCopyForward
  }, "Forward As Copy"), hasCustomEmoji && /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_teact__WEBPACK_IMPORTED_MODULE_0__["default"].Fragment, null, /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_ui_MenuSeparator__WEBPACK_IMPORTED_MODULE_18__["default"], {
    size: "thick"
  }), !customEmojiSets && /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_teact__WEBPACK_IMPORTED_MODULE_0__["default"].Fragment, null, /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_ui_placeholder_Skeleton__WEBPACK_IMPORTED_MODULE_19__["default"], {
    inline: true,
    className: "menu-loading-row"
  }), /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_ui_placeholder_Skeleton__WEBPACK_IMPORTED_MODULE_19__["default"], {
    inline: true,
    className: "menu-loading-row"
  })), customEmojiSets && customEmojiSets.length === 1 && /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_ui_MenuItem__WEBPACK_IMPORTED_MODULE_17__["default"], {
    withWrap: true,
    onClick: handleOpenCustomEmojiSets,
    className: "menu-custom-emoji-sets"
  }, (0,_common_helpers_renderText__WEBPACK_IMPORTED_MODULE_8__["default"])(oldLang('MessageContainsEmojiPack', customEmojiSets[0].title), ['simple_markdown', 'emoji'])), customEmojiSets && customEmojiSets.length > 1 && /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_ui_MenuItem__WEBPACK_IMPORTED_MODULE_17__["default"], {
    withWrap: true,
    onClick: handleOpenCustomEmojiSets,
    className: "menu-custom-emoji-sets"
  }, (0,_common_helpers_renderText__WEBPACK_IMPORTED_MODULE_8__["default"])(oldLang('MessageContainsEmojiPacks', customEmojiSets.length), ['simple_markdown']))), (canShowSeenBy || canShowReactionsCount) && /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_teact__WEBPACK_IMPORTED_MODULE_0__["default"].Fragment, null, /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_ui_MenuSeparator__WEBPACK_IMPORTED_MODULE_18__["default"], {
    size: hasCustomEmoji ? 'thin' : 'thick'
  }), /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_ui_MenuItem__WEBPACK_IMPORTED_MODULE_17__["default"], {
    ...
    dir: oldLang.isRtl ? 'rtl' : undefined
  }, canShowReactionsCount && message.reactors?.count ? canShowSeenBy && seenByDatesCount ? oldLang('Chat.OutgoingContextMixedReactionCount', [message.reactors.count, seenByDatesCount]) : oldLang('Chat.ContextReactionCount', message.reactors.count, 'i') : seenByDatesCount === 1 && seenByRecentPeers ? (0,_common_helpers_renderText__WEBPACK_IMPORTED_MODULE_8__["default"])((0,_util_entities_ids__WEBPACK_IMPORTED_MODULE_4__.isUserId)(seenByRecentPeers[0].id) ? (0,_global_helpers__WEBPACK_IMPORTED_MODULE_2__.getUserFullName)(seenByRecentPeers[0]) : seenByRecentPeers[0].title) : seenByDatesCount ? oldLang('Conversation.ContextMenuSeen', seenByDatesCount, 'i') : oldLang('Conversation.ContextMenuNoViews'))), /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_common_AvatarList__WEBPACK_IMPORTED_MODULE_15__["default"], {
    className: "avatars",
    size: "micro",
    peers: seenByRecentPeers
  }))), (canLoadReadDate || shouldRenderShowWhen || isEdited) && /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_ui_MenuSeparator__WEBPACK_IMPORTED_MODULE_18__["default"], {
    size: hasCustomEmoji ? 'thin' : 'thick'
  }), (canLoadReadDate || shouldRenderShowWhen) && /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_ReadTimeMenuItem__WEBPACK_IMPORTED_MODULE_22__["default"], {
    canLoadReadDate: canLoadReadDate,
    shouldRenderShowWhen: shouldRenderShowWhen,
    message: message,
    closeContextMenu: onClose
  }), isEdited && /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_LastEditTimeMenuItem__WEBPACK_IMPORTED_MODULE_20__["default"], {
    message: message
  })));
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,_teact__WEBPACK_IMPORTED_MODULE_0__.memo)(MessageContextMenu));
...
function ReadTimeMenuItem({
  ...
  return /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_ui_MenuItem__WEBPACK_IMPORTED_MODULE_4__["default"], {
    icon: "message-read",
  ...
  }, shouldRenderSkeleton ? /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_ui_placeholder_Skeleton__WEBPACK_IMPORTED_MODULE_5__["default"], {
    className: _TimeMenuItem_module_scss__WEBPACK_IMPORTED_MODULE_7__["default"].skeleton
  }) : /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_teact__WEBPACK_IMPORTED_MODULE_0__["default"].Fragment, null, Boolean(readDate) && lang('PmReadAt', (0,_util_dates_dateFormat__WEBPACK_IMPORTED_MODULE_2__.formatDateAtTime)(lang, readDate * 1000)), !readDate && shouldRenderShowWhen && /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("div", null, lang('PmRead'), /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("span", {
    className: _TimeMenuItem_module_scss__WEBPACK_IMPORTED_MODULE_7__["default"].get,
    onClick: handleOpenModal
  }, lang('PmReadShowWhen'))))));
}
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,_teact__WEBPACK_IMPORTED_MODULE_0__.memo)(ReadTimeMenuItem));
...
/* harmony import */ var _util_getMessageIdsForSelectedText__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../../../util/getMessageIdsForSelectedText */ "./src/util/getMessageIdsForSelectedText.ts");
...
/* harmony import */ var _common_helpers_renderMessageText__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../../../common/helpers/renderMessageText */ "./src/components/common/helpers/renderMessageText.ts");
...
function getMessageCopyOptions(message, statefulContent, href, canCopy, afterEffect, onCopyLink, onCopyMessages, onCopyNumber) {
  ...
  const options = [];
  const text = (0,_global_helpers__WEBPACK_IMPORTED_MODULE_3__.getMessageText)(message);
  const photo = (0,_global_helpers__WEBPACK_IMPORTED_MODULE_3__.getMessagePhoto)(message) || (!(0,_global_helpers__WEBPACK_IMPORTED_MODULE_3__.getWebPageVideo)(webPage) ? (0,_global_helpers__WEBPACK_IMPORTED_MODULE_3__.getWebPagePhoto)(webPage) : undefined);
  const contact = (0,_global_helpers__WEBPACK_IMPORTED_MODULE_3__.getMessageContact)(message);
  const mediaHash = photo ? (0,_global_helpers__WEBPACK_IMPORTED_MODULE_3__.getPhotoMediaHash)(photo, 'full') : undefined;
  const canImageBeCopied = canCopy && photo && (mediaHash || (0,_global_helpers__WEBPACK_IMPORTED_MODULE_3__.hasMediaLocalBlobUrl)(photo)) && _util_clipboard__WEBPACK_IMPORTED_MODULE_7__.CLIPBOARD_ITEM_SUPPORTED && !_util_browser_windowEnvironment__WEBPACK_IMPORTED_MODULE_6__.IS_SAFARI;
  const selection = window.getSelection();
  if (canImageBeCopied) {
    options.push({
      ...
      icon: 'copy-media',
      handler: () => {
        Promise.resolve(mediaHash ? _util_mediaLoader__WEBPACK_IMPORTED_MODULE_9__.fetch(mediaHash, _api_types__WEBPACK_IMPORTED_MODULE_2__.ApiMediaFormat.BlobUrl) : photo.blobUrl).then(_util_clipboard__WEBPACK_IMPORTED_MODULE_7__.copyImageToClipboard);
        afterEffect?.();
      }
    });
  }
  if (canCopy && href) {
    options.push({
      ...
      icon: 'copy',
      handler: () => {
        (0,_util_clipboard__WEBPACK_IMPORTED_MODULE_7__.copyTextToClipboard)(href);
        afterEffect?.();
      }
    });
    ...
    const chatTranslations = (0,_global_selectors__WEBPACK_IMPORTED_MODULE_5__.selectChatTranslations)(global, chatId);
    const {
      telyAiLanguage
    } = global.settings.byKey;
    const messageTranslation = telyAiLanguage && messageId ? chatTranslations?.byLangCode[telyAiLanguage]?.[messageId] : undefined;
    const {
      isPending,
      text: translatedText
    } = messageTranslation || {};
    if (translatedText && !isPending) {
      options.push({
        ...
        handler: () => {
          if (hasSelection) {
            ...
            copy_to_clipboard__WEBPACK_IMPORTED_MODULE_0___default()(translatedText.text);
          }
          afterEffect?.();
        }
      });
      ...
      options.push({
        ...
        icon: 'copy',
        handler: () => {
          const messageIds = (0,_util_getMessageIdsForSelectedText__WEBPACK_IMPORTED_MODULE_8__["default"])();
          if (messageIds?.length && onCopyMessages) {
            onCopyMessages(messageIds);
          } else if (hasSelection) {
            document.execCommand('copy');
          } else {
            const clipboardText = (0,_common_helpers_renderMessageText__WEBPACK_IMPORTED_MODULE_10__.renderMessageText)({
              message,
              shouldRenderAsHtml: true
            });
            if (clipboardText) {
              (0,_util_clipboard__WEBPACK_IMPORTED_MODULE_7__.copyHtmlToClipboard)(clipboardText.join(''), (0,_global_helpers_messageSummary__WEBPACK_IMPORTED_MODULE_4__.getMessageTextWithSpoilers)(message, statefulContent));
            }
          }
          afterEffect?.();
        }
...
function checkMessageHasSelection(message) {
  ...
  return (0,_global_helpers__WEBPACK_IMPORTED_MODULE_3__.getMessageHtmlId)(message.id) === selectedMessageElement?.id;
}
...
const ReactionButton = ({
  ...
  const animationRef = (0,_teact__WEBPACK_IMPORTED_MODULE_0__.useRef)();
  ...
  return /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_ui_Button__WEBPACK_IMPORTED_MODULE_18__["default"], {
    ...
    onClick: handleClick
  }, reaction.reaction.type === 'paid' ? /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_teact__WEBPACK_IMPORTED_MODULE_0__["default"].Fragment, null, /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_common_Sparkles__WEBPACK_IMPORTED_MODULE_17__["default"], {
    preset: "button"
  }), /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_common_reactions_PaidReactionEmoji__WEBPACK_IMPORTED_MODULE_15__["default"], {
    ...
    observeIntersection: observeIntersection
  }), shouldRenderPaidCounter && /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_common_AnimatedCounter__WEBPACK_IMPORTED_MODULE_13__["default"], {
    ref: counterRef,
  ...
  })) : /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_common_reactions_ReactionAnimatedEmoji__WEBPACK_IMPORTED_MODULE_16__["default"], {
    className: _ReactionButton_module_scss__WEBPACK_IMPORTED_MODULE_19__["default"].animatedEmoji,
    containerId: containerId,
    reaction: reaction.reaction,
    size: REACTION_SIZE,
    observeIntersection: observeIntersection
  }), recentReactors?.length ? /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_common_AvatarList__WEBPACK_IMPORTED_MODULE_14__["default"], {
    size: "mini",
    peers: recentReactors
  }) : /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_common_AnimatedCounter__WEBPACK_IMPORTED_MODULE_13__["default"], {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,_teact__WEBPACK_IMPORTED_MODULE_0__.memo)(ReactionButton));
...
const ReactionSelector = ({
  ...
  const availableReactions = (0,_teact__WEBPACK_IMPORTED_MODULE_0__.useMemo)(() => {
    const reactions = (() => {
  ...
  const reactionsToRender = (0,_teact__WEBPACK_IMPORTED_MODULE_0__.useMemo)(() => {
  ...
  const userReactionIndexes = (0,_teact__WEBPACK_IMPORTED_MODULE_0__.useMemo)(() => {
  ...
  const hintText = (0,_teact__WEBPACK_IMPORTED_MODULE_0__.useMemo)(() => {
    if (isInSavedMessages) {
      if (!isCurrentUserPremium) {
        const text = lang('lng_subscribe_tag_about');
        const parts = text.split('{link}');
        return /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("span", null, parts[0], /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_ui_Link__WEBPACK_IMPORTED_MODULE_8__["default"], {
          isPrimary: true,
  ...
  return /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("div", {
    ...
    className: cn('items')
  }, hintText && /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("div", {
    className: cn('hint')
  }, hintText), /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("div", {
    className: cn('reactions'),
    dir: lang.isRtl ? 'rtl' : undefined
  }, reactionsToRender.map((reaction, i) => 'reaction' in reaction ? /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_ReactionSelectorReaction__WEBPACK_IMPORTED_MODULE_10__["default"], {
  ...
  }) : /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_ReactionSelectorCustomReaction__WEBPACK_IMPORTED_MODULE_9__["default"], {
  ...
  })), withMoreButton && /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_ui_Button__WEBPACK_IMPORTED_MODULE_7__["default"], {
    color: "translucent",
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,_teact__WEBPACK_IMPORTED_MODULE_0__.memo)(ReactionSelector));
...
const ReactionSelectorCustomReaction = ({
  ...
  return /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("div", {
    ...
    onMouseDown: handleBeforeContextMenu,
    onContextMenu: handleContextMenu
  }, reaction.type === 'paid' ? /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_common_AnimatedIcon__WEBPACK_IMPORTED_MODULE_6__["default"], {
    tgsUrl: _common_helpers_animatedAssets__WEBPACK_IMPORTED_MODULE_2__.LOCAL_TGS_URLS.StarReaction,
    size: REACTION_SIZE,
    noLoop: false
  }) : /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_common_CustomEmoji__WEBPACK_IMPORTED_MODULE_7__["default"], {
    documentId: reaction.documentId,
    size: REACTION_SIZE
  }), isLocked && /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_common_icons_Icon__WEBPACK_IMPORTED_MODULE_8__["default"], {
    className: _ReactionSelectorReaction_module_scss__WEBPACK_IMPORTED_MODULE_9__["default"].lock,
    name: "lock-badge"
  }));
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,_teact__WEBPACK_IMPORTED_MODULE_0__.memo)(ReactionSelectorCustomReaction));
...
const ReactionSelectorReaction = ({
  ...
  return /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("div", {
  ...
  }, noAppearAnimation && /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("img", {
    ...
    draggable: false
  }), !isAnimationLoaded && !noAppearAnimation && /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_common_AnimatedSticker__WEBPACK_IMPORTED_MODULE_5__["default"], {
    ...
    forceAlways: true
  }), !isFirstPlay && !noAppearAnimation && /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_common_AnimatedSticker__WEBPACK_IMPORTED_MODULE_5__["default"], {
    ...
    onEnded: deactivate,
    forceAlways: true
  }), isLocked && /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_common_icons_Icon__WEBPACK_IMPORTED_MODULE_6__["default"], {
    className: _ReactionSelectorReaction_module_scss__WEBPACK_IMPORTED_MODULE_7__["default"].lock,
    name: "lock-badge"
  }));
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,_teact__WEBPACK_IMPORTED_MODULE_0__.memo)(ReactionSelectorReaction));
...
const Reactions = ({
  ...
  const totalCount = (0,_teact__WEBPACK_IMPORTED_MODULE_0__.useMemo)(() => results.reduce((acc, reaction) => acc + reaction.count, 0), [results]);
  const recentReactorsByReactionKey = (0,_teact__WEBPACK_IMPORTED_MODULE_0__.useMemo)(() => {
    const global = (0,_global__WEBPACK_IMPORTED_MODULE_1__.getGlobal)();
  ...
  const props = (0,_teact__WEBPACK_IMPORTED_MODULE_0__.useMemo)(() => {
  ...
  const paidLocalCount = (0,_teact__WEBPACK_IMPORTED_MODULE_0__.useMemo)(() => results.find(r => r.reaction.type === 'paid')?.localAmount || 0, [results]);
  ...
  return /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("div", {
    ...
    isChosen,
    tag
  }) => areTags ? /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_SavedTagButton__WEBPACK_IMPORTED_MODULE_10__["default"], {
    key: reactionKey,
    ...
    observeIntersection: observeIntersection
  }) : /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_ReactionButton__WEBPACK_IMPORTED_MODULE_9__["default"], {
    key: reactionKey,
    chatId: message.chatId,
    messageId: message.id,
    className: "message-reaction",
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,_teact__WEBPACK_IMPORTED_MODULE_0__.memo)(Reactions));
...
const SavedTagButton = ({
  ...
  return /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_ui_Button__WEBPACK_IMPORTED_MODULE_10__["default"], {
    ...
    onContextMenu: handleContextMenu,
    ref: ref
  }, /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_common_reactions_ReactionAnimatedEmoji__WEBPACK_IMPORTED_MODULE_8__["default"], {
    ...
    size: REACTION_SIZE,
    observeIntersection: observeIntersection
  }), hasText && /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("span", {
    className: _ReactionButton_module_scss__WEBPACK_IMPORTED_MODULE_13__["default"].tagText
  }, title && /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("span", null, title), withCount && /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("span", null, count)), /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("svg", {
  ...
  })), withContextMenu && /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_modals_prompt_PromptDialog__WEBPACK_IMPORTED_MODULE_9__["default"], {
  ...
  }), withContextMenu && contextMenuAnchor && /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_ui_Menu__WEBPACK_IMPORTED_MODULE_11__["default"], {
    ref: menuRef,
  ...
  }, /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_ui_MenuItem__WEBPACK_IMPORTED_MODULE_12__["default"], {
    icon: "tag-filter",
    onClick: handleClick
  }, lang('SavedTagFilterByTag')), /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_ui_MenuItem__WEBPACK_IMPORTED_MODULE_12__["default"], {
    icon: "tag-name",
    onClick: openRenamePrompt
  }, lang(tag?.title ? 'SavedTagRenameTag' : 'SavedTagLabelTag')), /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_ui_MenuItem__WEBPACK_IMPORTED_MODULE_12__["default"], {
    icon: "tag-crossed",
    destructive: true,
    onClick: handleRemoveClick
  }, lang('SavedTagRemoveTag'))));
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,_teact__WEBPACK_IMPORTED_MODULE_0__.memo)(SavedTagButton));
...
const PromptDialog = ({
  ...
  const lang = (0,_hooks_useOldLang__WEBPACK_IMPORTED_MODULE_2__["default"])();
  const [text, setText] = (0,_teact__WEBPACK_IMPORTED_MODULE_0__.useState)(initialValue);
  ...
  return /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_ui_Modal__WEBPACK_IMPORTED_MODULE_5__["default"], {
    className: "narrow",
    title: title,
    isOpen: isOpen,
    onClose: onClose,
    isSlim: true
  }, Boolean(subtitle) && /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("div", {
    className: _PromptDialog_module_scss__WEBPACK_IMPORTED_MODULE_6__["default"].subtitle
  }, subtitle), /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_ui_InputText__WEBPACK_IMPORTED_MODULE_4__["default"], {
  ...
  }, /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_ui_Button__WEBPACK_IMPORTED_MODULE_3__["default"], {
    className: "confirm-dialog-button",
    onClick: handleSubmit
  }, submitText || lang('Save')), /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_ui_Button__WEBPACK_IMPORTED_MODULE_3__["default"], {
    className: "confirm-dialog-button",
    isText: true,
    onClick: onClose
  }, lang('Cancel'))));
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,_teact__WEBPACK_IMPORTED_MODULE_0__.memo)(PromptDialog));
...
/* harmony import */ var _components_chatAssistant_ai_chatfolders_tag_filter__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../components/chatAssistant/ai-chatfolders/tag-filter */ "./src/components/chatAssistant/ai-chatfolders/tag-filter.ts");
/* harmony import */ var _components_chatAssistant_ai_chatfolders_util__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../components/chatAssistant/ai-chatfolders/util */ "./src/components/chatAssistant/ai-chatfolders/util.ts");
/* harmony import */ var _components_chatAssistant_variables__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../components/chatAssistant/variables */ "./src/components/chatAssistant/variables.ts");
/* harmony import */ var _useForceUpdate__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./useForceUpdate */ "./src/hooks/useForceUpdate.ts");
...
function useFolderManagerForOrderedIds(folderId) {
  const forceUpdate = (0,_useForceUpdate__WEBPACK_IMPORTED_MODULE_6__["default"])();
  (0,_lib_teact_teact__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => (0,_util_folderManager__WEBPACK_IMPORTED_MODULE_2__.addOrderedIdsCallback)(folderId, forceUpdate), [folderId, forceUpdate]);
  if (folderId === _config__WEBPACK_IMPORTED_MODULE_1__.UNREAD_FOLDER_ID) {
    return (0,_util_folderManager__WEBPACK_IMPORTED_MODULE_2__.getUnreadChatsByFolderId)()[_config__WEBPACK_IMPORTED_MODULE_1__.ALL_FOLDER_ID];
  }
  if (folderId === _config__WEBPACK_IMPORTED_MODULE_1__.PRESET_FOLDER_ID) {
    return (0,_components_chatAssistant_ai_chatfolders_tag_filter__WEBPACK_IMPORTED_MODULE_3__.filterPresetTag)((0,_util_folderManager__WEBPACK_IMPORTED_MODULE_2__.getOrderedIds)(_config__WEBPACK_IMPORTED_MODULE_1__.ALL_FOLDER_ID)?.filter(i => !(0,_components_chatAssistant_ai_chatfolders_util__WEBPACK_IMPORTED_MODULE_4__.isChatBot)(i)));
  }
  if (folderId === _config__WEBPACK_IMPORTED_MODULE_1__.AI_FOLDER_ID) {
    return (0,_components_chatAssistant_ai_chatfolders_tag_filter__WEBPACK_IMPORTED_MODULE_3__.filterAITag)((0,_util_folderManager__WEBPACK_IMPORTED_MODULE_2__.getOrderedIds)(_config__WEBPACK_IMPORTED_MODULE_1__.ALL_FOLDER_ID)?.filter(i => !(0,_components_chatAssistant_ai_chatfolders_util__WEBPACK_IMPORTED_MODULE_4__.isChatBot)(i)));
  }
  if (folderId === _config__WEBPACK_IMPORTED_MODULE_1__.ALL_FOLDER_ID) {
    const res = (0,_util_folderManager__WEBPACK_IMPORTED_MODULE_2__.getOrderedIds)(folderId);
    if (res && res?.indexOf(_components_chatAssistant_variables__WEBPACK_IMPORTED_MODULE_5__.GLOBAL_SUMMARY_CHATID) < 0) {
      res?.unshift(_components_chatAssistant_variables__WEBPACK_IMPORTED_MODULE_5__.GLOBAL_SUMMARY_CHATID);
    } else {
      res?.sort((a, b) => a === _components_chatAssistant_variables__WEBPACK_IMPORTED_MODULE_5__.GLOBAL_SUMMARY_CHATID ? -1 : b === _components_chatAssistant_variables__WEBPACK_IMPORTED_MODULE_5__.GLOBAL_SUMMARY_CHATID ? 1 : 0);
    }
    return res;
  }
  return (0,_util_folderManager__WEBPACK_IMPORTED_MODULE_2__.getOrderedIds)(folderId);
}
function useFolderManagerForUnreadCounters() {
  const forceUpdate = (0,_useForceUpdate__WEBPACK_IMPORTED_MODULE_6__["default"])();
  (0,_lib_teact_teact__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => (0,_util_folderManager__WEBPACK_IMPORTED_MODULE_2__.addUnreadCountersCallback)(forceUpdate), [forceUpdate]);
  return (0,_util_folderManager__WEBPACK_IMPORTED_MODULE_2__.getUnreadCounters)();
}
function useFolderManagerForChatsCount() {
  const forceUpdate = (0,_useForceUpdate__WEBPACK_IMPORTED_MODULE_6__["default"])();
  (0,_lib_teact_teact__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => (0,_util_folderManager__WEBPACK_IMPORTED_MODULE_2__.addChatsCountCallback)(forceUpdate), [forceUpdate]);
  return (0,_util_folderManager__WEBPACK_IMPORTED_MODULE_2__.getChatsCount)();
}
function useFolderManagerForUnreadChatsByFolder() {
  const forceUpdate = (0,_useForceUpdate__WEBPACK_IMPORTED_MODULE_6__["default"])();
  (0,_lib_teact_teact__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => (0,_util_folderManager__WEBPACK_IMPORTED_MODULE_2__.addUnreadChatsByFolderIdCallback)(forceUpdate), [forceUpdate]);
  return (0,_util_folderManager__WEBPACK_IMPORTED_MODULE_2__.getUnreadChatsByFolderId)();
}
...
const useSchedule = (canScheduleUntilOnline, onCancel, openAt) => {
  ...
  const [onScheduled, setOnScheduled] = (0,_teact__WEBPACK_IMPORTED_MODULE_0__.useState)();
  ...
  const scheduledMaxDate = new Date();
  scheduledMaxDate.setFullYear(scheduledMaxDate.getFullYear() + 1);
  const calendar = /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_components_common_CalendarModal_async__WEBPACK_IMPORTED_MODULE_6__["default"], {
...
//# sourceMappingURL=src_components_common_AnimatedIconFromSticker_tsx-src_components_common_BadgeButton_tsx-src_c-99cb87.2f72646c04993286f2e2.js.map