...
var fasttextmodule = (() => {
  ...
  return function (fasttextmodule = {}) {
    ...
    if (ENVIRONMENT_IS_NODE) {
      var fs = __webpack_require__(/*! fs */ "?5f08");
      var nodePath = __webpack_require__(/*! path */ "./node_modules/path-browserify/index.js");
    ...
    var wasmBinaryFile;
    wasmBinaryFile = "fasttext-wasm.wasm";
    ...
    function getRandomDevice() {
      if (typeof crypto == "object" && typeof crypto["getRandomValues"] == "function") {
        ...
        try {
          var crypto_module = __webpack_require__(/*! crypto */ "?f1d5");
    ...
    var dynCall_fiij = Module["dynCall_fiij"] = function () {
      return (dynCall_fiij = Module["dynCall_fiij"] = Module["asm"]["dynCall_fiij"]).apply(null, arguments);
    };
    ...
    var ___emscripten_embedded_file_data = Module["___emscripten_embedded_file_data"] = 943176;
...
if (true) module.exports = fasttextmodule;else // removed by dead control flow
{}
...
"use strict";
module.exports = __webpack_require__.p + "fasttext-wasm.bd5b9292c04d265a9bfb.wasm";
...
/* harmony import */ var _fasttext_wasm_cjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./fasttext-wasm.cjs */ "./src/lib/fasttextweb/fasttext-wasm.cjs");
/* harmony import */ var _fasttext_wasm_cjs__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_fasttext_wasm_cjs__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _fasttext_wasm_wasm__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./fasttext-wasm.wasm */ "./src/lib/fasttextweb/fasttext-wasm.wasm");
...
const fastTextPromise = _fasttext_wasm_cjs__WEBPACK_IMPORTED_MODULE_2___default()({
  locateFile: (path, prefix) => {
    if (path.endsWith('.wasm')) {
      return _fasttext_wasm_wasm__WEBPACK_IMPORTED_MODULE_3__;
    }
    return prefix + path;
  }
}).then(fastText => {
...
async function detectLanguage(text, threshold) {
...
async function detectLanguageProbability(text, labelsCount, threshold) {
  if (!fastTextInstance) await fastTextPromise;
  const labels = await fastTextInstance.makePrediction('predict-prob', text, labelsCount.toString(), threshold.toString());
...
/******/ 		var __webpack_exports__ = __webpack_require__.O(undefined, ["vendors-node_modules_buffer_index_js","vendors-node_modules_path-browserify_index_js","src_config_ts-src_util_schedulers_ts"], () => (__webpack_require__("./src/lib/fasttextweb/fasttext.worker.ts")))
...
/******/ 			return "" + chunkId + "." + {"vendors-node_modules_buffer_index_js":"4f6bb7c2086995505786","vendors-node_modules_path-browserify_index_js":"3cd41444ea3278a5b1cf","src_config_ts-src_util_schedulers_ts":"ff682f0a19d88914bc4c"}[chunkId] + ".js";
/******/ 		};
/******/ 	})();
/******/ 	
...
/******/ 		var installedChunks = {
/******/ 			"src_lib_fasttextweb_fasttext_worker_ts": 1
/******/ 		};
/******/ 		
...
/******/ 		};
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkTelyAI"] = self["webpackChunkTelyAI"] || [];
...
/******/ 		__webpack_require__.x = () => {
/******/ 			return Promise.all(["vendors-node_modules_buffer_index_js","vendors-node_modules_path-browserify_index_js","src_config_ts-src_util_schedulers_ts"].map(__webpack_require__.e, __webpack_require__)).then(next);
/******/ 		};
/******/ 	})();
/******/ 	
/************************************************************************/
...
/******/ })()
;
//# sourceMappingURL=src_lib_fasttextweb_fasttext_worker_ts.53c2ca542967bb9efdc3.js.map