(self["webpackChunkTelyAI"] = self["webpackChunkTelyAI"] || []).push([["vendors-node_modules_lowlight_lib_index_js"],{
...
function createLowlight(grammars) {
  const high = highlight_js_lib_core__WEBPACK_IMPORTED_MODULE_1__["default"].newInstance()
  ...
  function highlight(language, value, options) {
    ;(0,devlop__WEBPACK_IMPORTED_MODULE_0__.ok)(typeof language === 'string', 'expected `string` as `name`')
    ;(0,devlop__WEBPACK_IMPORTED_MODULE_0__.ok)(typeof value === 'string', 'expected `string` as `value`')
  ...
  function register(grammarsOrName, grammar) {
    if (typeof grammarsOrName === 'string') {
      (0,devlop__WEBPACK_IMPORTED_MODULE_0__.ok)(grammar !== undefined, 'expected `grammar`')
  ...
  function registerAlias(aliasesOrName, alias) {
    if (typeof aliasesOrName === 'string') {
      (0,devlop__WEBPACK_IMPORTED_MODULE_0__.ok)(alias !== undefined)
...
//# sourceMappingURL=vendors-node_modules_lowlight_lib_index_js.56ecab53b46da5b6dabd.js.map