...
const AuthCode = ({
  ...
  const [code, setCode] = (0,_teact__WEBPACK_IMPORTED_MODULE_0__.useState)('');
  const [isTracking, setIsTracking] = (0,_teact__WEBPACK_IMPORTED_MODULE_0__.useState)(false);
  const [trackingDirection, setTrackingDirection] = (0,_teact__WEBPACK_IMPORTED_MODULE_0__.useState)(1);
  (0,_teact__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    if (!_util_browser_windowEnvironment__WEBPACK_IMPORTED_MODULE_2__.IS_TOUCH_ENV) {
  ...
  const onCodeChange = (0,_teact__WEBPACK_IMPORTED_MODULE_0__.useCallback)(e => {
    if (authErrorKey) {
      clearAuthErrorKey();
    }
    const {
  ...
  return /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("div", {
    ...
    className: "auth-form"
  }, /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_common_TrackingMonkey__WEBPACK_IMPORTED_MODULE_7__["default"], {
    code: code,
    codeLength: CODE_LENGTH,
    isTracking: isTracking,
    trackingDirection: trackingDirection
  }), /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("h1", null, authPhoneNumber, /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("div", {
    ...
    withNodes: true,
    withMarkdown: true
  })), /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_ui_InputText__WEBPACK_IMPORTED_MODULE_8__["default"], {
    ref: inputRef,
    id: "sign-in-code",
    label: lang('Code'),
    ...
    autoComplete: "off",
    inputMode: "numeric"
  }), authIsLoading && /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_ui_Loading__WEBPACK_IMPORTED_MODULE_9__["default"], null)));
};
...
const AuthPassword = ({
  ...
  const [showPassword, setShowPassword] = (0,_teact__WEBPACK_IMPORTED_MODULE_0__.useState)(false);
  const handleChangePasswordVisibility = (0,_teact__WEBPACK_IMPORTED_MODULE_0__.useCallback)(isVisible => {
    setShowPassword(isVisible);
  }, []);
  const handleSubmit = (0,_teact__WEBPACK_IMPORTED_MODULE_0__.useCallback)(password => {
    setAuthPassword({
      password
    });
  }, [setAuthPassword]);
  return /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("div", {
    ...
    className: "auth-form"
  }, /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_common_PasswordMonkey__WEBPACK_IMPORTED_MODULE_5__["default"], {
    isPasswordVisible: showPassword
  }), /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("h1", null, lang('LoginHeaderPassword')), /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("p", {
    className: "note"
  }, lang('LoginEnterPasswordDescription')), /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_common_PasswordForm__WEBPACK_IMPORTED_MODULE_4__["default"], {
...
const AuthRegister = ({
  ...
  const lang = (0,_hooks_useLang__WEBPACK_IMPORTED_MODULE_3__["default"])();
  const [isButtonShown, setIsButtonShown] = (0,_teact__WEBPACK_IMPORTED_MODULE_0__.useState)(false);
  const [croppedFile, setCroppedFile] = (0,_teact__WEBPACK_IMPORTED_MODULE_0__.useState)();
  const [firstName, setFirstName] = (0,_teact__WEBPACK_IMPORTED_MODULE_0__.useState)('');
  const [lastName, setLastName] = (0,_teact__WEBPACK_IMPORTED_MODULE_0__.useState)('');
  const handleFirstNameChange = (0,_teact__WEBPACK_IMPORTED_MODULE_0__.useCallback)(event => {
    if (authErrorKey) {
      clearAuthErrorKey();
    }
    const {
  ...
  const handleLastNameChange = (0,_teact__WEBPACK_IMPORTED_MODULE_0__.useCallback)(event => {
    const {
      target
    } = event;
  ...
  return /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("div", {
    ...
    className: "auth-form"
  }, /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("form", {
    action: "",
    method: "post",
    onSubmit: handleSubmit
  }, /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_ui_AvatarEditable__WEBPACK_IMPORTED_MODULE_4__["default"], {
    onChange: setCroppedFile
  }), /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("h2", null, lang('YourName')), /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("p", {
    className: "note"
  }, lang('LoginRegisterDesc')), /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_ui_InputText__WEBPACK_IMPORTED_MODULE_6__["default"], {
  ...
  }), isButtonShown && /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_ui_Button__WEBPACK_IMPORTED_MODULE_5__["default"], {
    size: "smaller",
    type: "submit",
    ripple: true,
    isLoading: authIsLoading
...
const PasswordMonkey = ({
  ...
  const handleFirstMonkeyLoad = (0,_teact__WEBPACK_IMPORTED_MODULE_0__.useCallback)(markFirstMonkeyLoaded, [markFirstMonkeyLoaded]);
  return /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("div", {
    id: "monkey",
    className: isBig ? 'big' : ''
  }, !isFirstMonkeyLoaded && /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("div", {
    className: "monkey-preview"
  }), /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_AnimatedSticker__WEBPACK_IMPORTED_MODULE_6__["default"], {
...
const TrackingMonkey = ({
  ...
  const [isFirstMonkeyLoaded, setIsFirstMonkeyLoaded] = (0,_teact__WEBPACK_IMPORTED_MODULE_0__.useState)(false);
  const {
    isMobile
  ...
  const handleFirstMonkeyLoad = (0,_teact__WEBPACK_IMPORTED_MODULE_0__.useCallback)(() => setIsFirstMonkeyLoaded(true), []);
  ...
  return /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("div", {
    ...
    className: "monkey-preview"
  }), /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_AnimatedSticker__WEBPACK_IMPORTED_MODULE_4__["default"], {
...
//# sourceMappingURL=BundleAuth.7038b018f26dc9681e8d.js.map