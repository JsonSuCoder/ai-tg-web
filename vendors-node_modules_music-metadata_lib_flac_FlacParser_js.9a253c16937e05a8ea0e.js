"use strict";
(self["webpackChunkTelyAI"] = self["webpackChunkTelyAI"] || []).push([["vendors-node_modules_music-metadata_lib_flac_FlacParser_js"],{
...
/* harmony import */ var _ogg_vorbis_Vorbis_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../ogg/vorbis/Vorbis.js */ "./node_modules/music-metadata/lib/ogg/vorbis/Vorbis.js");
...
/* harmony import */ var _ogg_vorbis_VorbisStream_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../ogg/vorbis/VorbisStream.js */ "./node_modules/music-metadata/lib/ogg/vorbis/VorbisStream.js");
...
/* harmony import */ var _FlacToken_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./FlacToken.js */ "./node_modules/music-metadata/lib/flac/FlacToken.js");
...
class FlacContentError extends (0,_ParseError_js__WEBPACK_IMPORTED_MODULE_7__.makeUnexpectedFileContentError)('FLAC') {
}
class FlacParser extends _id3v2_AbstractID3Parser_js__WEBPACK_IMPORTED_MODULE_3__.AbstractID3Parser {
    constructor() {
        super(...arguments);
        this.vorbisParser = new _ogg_vorbis_VorbisStream_js__WEBPACK_IMPORTED_MODULE_5__.VorbisStream(this.metadata, this.options);
        this.padding = 0;
    }
    async postId3v2Parse() {
        const fourCC = await this.tokenizer.readToken(_common_FourCC_js__WEBPACK_IMPORTED_MODULE_4__.FourCcToken);
        ...
        do {
            // Read block header
            blockHeader = await this.tokenizer.readToken(_FlacToken_js__WEBPACK_IMPORTED_MODULE_8__.BlockHeader);
            // Parse block data
    ...
    async parseDataBlock(blockHeader) {
        ...
        switch (blockHeader.type) {
            case _FlacToken_js__WEBPACK_IMPORTED_MODULE_8__.BlockType.STREAMINFO:
                return this.readBlockStreamInfo(blockHeader.length);
            case _FlacToken_js__WEBPACK_IMPORTED_MODULE_8__.BlockType.PADDING:
                this.padding += blockHeader.length;
                break;
            case _FlacToken_js__WEBPACK_IMPORTED_MODULE_8__.BlockType.APPLICATION:
                break;
            case _FlacToken_js__WEBPACK_IMPORTED_MODULE_8__.BlockType.SEEKTABLE:
                break;
            case _FlacToken_js__WEBPACK_IMPORTED_MODULE_8__.BlockType.VORBIS_COMMENT:
                return this.readComment(blockHeader.length);
            case _FlacToken_js__WEBPACK_IMPORTED_MODULE_8__.BlockType.CUESHEET:
                break;
            case _FlacToken_js__WEBPACK_IMPORTED_MODULE_8__.BlockType.PICTURE:
    ...
    async readBlockStreamInfo(dataLen) {
        if (dataLen !== _FlacToken_js__WEBPACK_IMPORTED_MODULE_8__.BlockStreamInfo.len)
            throw new FlacContentError('Unexpected block-stream-info length');
        const streamInfo = await this.tokenizer.readToken(_FlacToken_js__WEBPACK_IMPORTED_MODULE_8__.BlockStreamInfo);
    ...
    async parsePicture(dataLen) {
        ...
        return this.addPictureTag(await this.tokenizer.readToken(new _ogg_vorbis_Vorbis_js__WEBPACK_IMPORTED_MODULE_2__.VorbisPictureToken(dataLen)));
    }
...
/* harmony export */   BlockStreamInfo: () => (/* binding */ BlockStreamInfo),
...
const BlockHeader = {
    ...
    get: (buf, off) => {
        return {
            lastBlock: _common_Util_js__WEBPACK_IMPORTED_MODULE_0__.getBit(buf, off, 7),
            type: _common_Util_js__WEBPACK_IMPORTED_MODULE_0__.getBitAllignedNumber(buf, off, 1, 7),
            length: token_types__WEBPACK_IMPORTED_MODULE_1__.UINT24_BE.get(buf, off + 1)
        };
    }
};
/**
...
const BlockStreamInfo = {
    ...
    get: (buf, off) => {
        return {
            ...
            minimumBlockSize: token_types__WEBPACK_IMPORTED_MODULE_1__.UINT16_BE.get(buf, off),
            // The maximum block size (in samples) used in the stream.
            // (Minimum blocksize == maximum blocksize) implies a fixed-blocksize stream.
            maximumBlockSize: token_types__WEBPACK_IMPORTED_MODULE_1__.UINT16_BE.get(buf, off + 2) / 1000,
            // The minimum frame size (in bytes) used in the stream.
            // May be 0 to imply the value is not known.
            minimumFrameSize: token_types__WEBPACK_IMPORTED_MODULE_1__.UINT24_BE.get(buf, off + 4),
            // The maximum frame size (in bytes) used in the stream.
            // May be 0 to imply the value is not known.
            maximumFrameSize: token_types__WEBPACK_IMPORTED_MODULE_1__.UINT24_BE.get(buf, off + 7),
            // Sample rate in Hz. Though 20 bits are available,
            // the maximum sample rate is limited by the structure of frame headers to 655350Hz.
            // Also, a value of 0 is invalid.
            sampleRate: token_types__WEBPACK_IMPORTED_MODULE_1__.UINT24_BE.get(buf, off + 10) >> 4,
            // probably slower: sampleRate: common.getBitAllignedNumber(buf, off + 10, 0, 20),
            // (number of channels)-1. FLAC supports from 1 to 8 channels
            channels: _common_Util_js__WEBPACK_IMPORTED_MODULE_0__.getBitAllignedNumber(buf, off + 12, 4, 3) + 1,
            // bits per sample)-1.
            // FLAC supports from 4 to 32 bits per sample. Currently the reference encoder and decoders only support up to 24 bits per sample.
            bitsPerSample: _common_Util_js__WEBPACK_IMPORTED_MODULE_0__.getBitAllignedNumber(buf, off + 12, 7, 5) + 1,
            // Total samples in stream.
            // 'Samples' means inter-channel sample, i.e. one second of 44.1Khz audio will have 44100 samples regardless of the number of channels.
            // A value of zero here means the number of total samples is unknown.
            totalSamples: _common_Util_js__WEBPACK_IMPORTED_MODULE_0__.getBitAllignedNumber(buf, off + 13, 4, 36),
            // the MD5 hash of the file (see notes for usage... it's a littly tricky)
            fileMD5: new token_types__WEBPACK_IMPORTED_MODULE_1__.Uint8ArrayType(16).get(buf, off + 18)
        };
    }
};
...
class VorbisDecoder {
    ...
    readStringUtf8() {
        ...
        const value = (0,_borewit_text_codec__WEBPACK_IMPORTED_MODULE_1__.textDecode)(this.data.subarray(this.offset, this.offset + len), 'utf-8');
        this.offset += len;
        return value;
    }
    parseUserComment() {
...
/* harmony export */   VorbisStream: () => (/* binding */ VorbisStream)
/* harmony export */ });
/* harmony import */ var token_types__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! token-types */ "./node_modules/token-types/lib/index.js");
/* harmony import */ var debug__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! debug */ "./node_modules/debug/src/browser.js");
...
//# sourceMappingURL=vendors-node_modules_music-metadata_lib_flac_FlacParser_js.9a253c16937e05a8ea0e.js.map