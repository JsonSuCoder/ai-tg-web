"use strict";
(self["webpackChunkTelyAI"] = self["webpackChunkTelyAI"] || []).push([["vendors-node_modules_music-metadata_lib_mp4_MP4Parser_js"],{
...
/* harmony import */ var _type_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../type.js */ "./node_modules/music-metadata/lib/matroska/types.js");
...
/* harmony import */ var _borewit_text_codec__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @borewit/text-codec */ "./node_modules/@borewit/text-codec/lib/index.js");
...
class MP4Parser extends _common_BasicParser_js__WEBPACK_IMPORTED_MODULE_2__.BasicParser {
        ...
        return metaAtom.readAtoms(this.tokenizer, async (child, remaining) => {
            ...
            switch (child.header.name) {
                ...
                default: {
                    ...
                    this.addWarning(`Unsupported meta-item: ${tagKey}[${child.header.name}] => value=${(0,uint8array_extras__WEBPACK_IMPORTED_MODULE_7__.uint8ArrayToHex)(uint8Array)} ascii=${(0,_borewit_text_codec__WEBPACK_IMPORTED_MODULE_8__.textDecode)(uint8Array, 'ascii')}`);
                }
            }
        ...
        switch (dataAtom.type.type) {
            case 0: // reserved: Reserved for use where no type needs to be indicated
                switch (tagKey) {
                    ...
                    case 'rate': {
                        const rate = (0,_borewit_text_codec__WEBPACK_IMPORTED_MODULE_8__.textDecode)(dataAtom.value, 'ascii');
            ...
            case 18: // Unknown: Found in m4b in combination with a '©gen' tag
                await this.addTag(tagKey, (0,_borewit_text_codec__WEBPACK_IMPORTED_MODULE_8__.textDecode)(dataAtom.value));
                break;
            case 13: // JPEG
    ...
    async parseTrackBox(trakBox) {
        ...
        await trakBox.readAtoms(this.tokenizer, async (child, remaining) => {
            ...
            switch (child.header.name) {
                case 'chap': {
                    const chap = await this.tokenizer.readToken(new _AtomToken_js__WEBPACK_IMPORTED_MODULE_5__.ChapterTrackReferenceBox(remaining));
                    track.chapterList = chap;
                    break;
                }
                case 'tkhd': // TrackHeaderBox
                    track.header = await this.tokenizer.readToken(new _AtomToken_js__WEBPACK_IMPORTED_MODULE_5__.TrackHeaderAtom(payLoadLength));
                    break;
                case 'hdlr': // TrackHeaderBox
                    track.handler = await this.tokenizer.readToken(new _AtomToken_js__WEBPACK_IMPORTED_MODULE_5__.HandlerBox(payLoadLength));
                ...
                case 'mdhd': { // Parse media header (mdhd) box
                    const mdhd_data = await this.tokenizer.readToken(new _AtomToken_js__WEBPACK_IMPORTED_MODULE_5__.MdhdAtom(payLoadLength));
                    track.media.header = mdhd_data;
                    break;
                }
                case 'stco': {
                    const stco = await this.tokenizer.readToken(new _AtomToken_js__WEBPACK_IMPORTED_MODULE_5__.StcoAtom(payLoadLength));
                    track.chunkOffsetTable = stco.entries; // remember chunk offsets
                    break;
                }
                case 'stsc': { // sample-to-Chunk box
                    const stsc = await this.tokenizer.readToken(new _AtomToken_js__WEBPACK_IMPORTED_MODULE_5__.StscAtom(payLoadLength));
                    track.sampleToChunkTable = stsc.entries;
                    break;
                }
                case 'stsd': { // sample description box
                    const stsd = await this.tokenizer.readToken(new _AtomToken_js__WEBPACK_IMPORTED_MODULE_5__.StsdAtom(payLoadLength));
                ...
                case 'stts': { // time-to-sample table
                    const stts = await this.tokenizer.readToken(new _AtomToken_js__WEBPACK_IMPORTED_MODULE_5__.SttsAtom(payLoadLength));
                    track.timeToSampleTable = stts.entries;
                    break;
                }
                case 'stsz': {
                    const stsz = await this.tokenizer.readToken(new _AtomToken_js__WEBPACK_IMPORTED_MODULE_5__.StszAtom(payLoadLength));
        ...
        return trafBox.readAtoms(this.tokenizer, async (child, remaining) => {
            ...
            switch (child.header.name) {
                case 'tfhd': { // TrackFragmentHeaderBox
                    const fragmentHeaderBox = new _AtomToken_js__WEBPACK_IMPORTED_MODULE_5__.TrackFragmentHeaderBox(child.getPayloadLength(remaining));
                ...
                case 'trun': { // TrackRunBox
                    const trackRunBox = new _AtomToken_js__WEBPACK_IMPORTED_MODULE_5__.TrackRunBox(payLoadLength);
...
//# sourceMappingURL=vendors-node_modules_music-metadata_lib_mp4_MP4Parser_js.d386fe5fc22b8bb10923.js.map