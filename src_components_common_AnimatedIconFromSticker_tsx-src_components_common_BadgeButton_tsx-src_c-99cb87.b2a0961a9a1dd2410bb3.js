...
const MessageContextMenu = ({
  ...
  }, shouldShowGiftButton && /*#__PURE__*/_teact__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(_ui_MenuItem__WEBPACK_IMPORTED_MODULE_16__["default"], {
    icon: "gift",
...
function getMessageCopyOptions(message, statefulContent, href, canCopy, afterEffect, onCopyLink, onCopyMessages, onCopyNumber) {
  ...
  if (canCopy && href) {
    ...
    const messageTranslation = autoTranslateLanguage && messageId ? chatTranslations?.byLangCode[autoTranslateLanguage]?.[messageId] : undefined;
    const {
      isPending,
      text: translatedText
    } = messageTranslation || {};
...
//# sourceMappingURL=src_components_common_AnimatedIconFromSticker_tsx-src_components_common_BadgeButton_tsx-src_c-99cb87.b2a0961a9a1dd2410bb3.js.map