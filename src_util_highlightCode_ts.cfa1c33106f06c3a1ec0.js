...
const lowlight = (0,lowlight__WEBPACK_IMPORTED_MODULE_0__.createLowlight)({});
...
function treeToElements(tree) {
  ...
  if (tree.type === 'root') {
    return _lib_teact_teact__WEBPACK_IMPORTED_MODULE_1__["default"].createElement('code', {
  ...
  return _lib_teact_teact__WEBPACK_IMPORTED_MODULE_1__["default"].createElement(name, {
    className
  }, children);
}
